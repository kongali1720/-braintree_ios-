...
@property (nonatomic, readonly, copy) NSString * _Nullable applePayCountryCode;
@property (nonatomic, readonly, copy) NSString * _Nullable applePayCurrencyCode;
@property (nonatomic, readonly, copy) NSString * _Nullable applePayMerchantIdentifier;
@property (nonatomic, readonly, copy) NSArray<PKPaymentNetwork> * _Nullable applePaySupportedNetworks;
@end
...
SWIFT_CLASS("_TtC13BraintreeCore11BTHTTPError")
@interface BTHTTPError : NSObject
...
SWIFT_CLASS("_TtC13BraintreeCore10BTKeychain")
@interface BTKeychain : NSObject
/// Saves a <code>String</code> to the keychain.
/// \param string the <code>String</code> to be saved to the keychain
///
/// \param key the key to be used to access it later
///
///
/// returns:
/// <code>true</code> if the key/value pair was written successfully, <code>false</code> otherwise
+ (BOOL)setString:(NSString * _Nonnull)string forKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
/// Reads a <code>String</code> from the keychain.
/// \param key the key associated to the desired <code>String</code> value in the keychain.
///
///
/// returns:
/// the <code>String</code> read from the keychain if successful, otherwise the empty <code>String</code>.
...
SWIFT_PROTOCOL("_TtP13BraintreeCore34BTViewControllerPresentingDelegate_")
...
/// Your implementation should present the viewController modally, e.g. via <code>presentViewController:animated:completion:</code>
/// \param client The payment client
///
/// \param viewController The view controller to present
///
- (void)paymentClient:(id _Nonnull)client requestsPresentationOfViewController:(UIViewController * _Nonnull)viewController;
/// The payment client requires dismissal of a view controller.
/// Your implementation should dismiss the viewController, e.g. via <code>dismissViewControllerAnimated:completion:</code>
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
///   </li>
/// </ul>
- (void)paymentClient:(id _Nonnull)client requestsDismissalOfViewController:(UIViewController * _Nonnull)viewController;
@end
